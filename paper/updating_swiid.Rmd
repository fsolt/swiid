...
Iran and Argentina---countries that are not member of the LIS---also make the top ten, with observations in `r iran_obs` and `r arg_obs` country-years, respectively.
