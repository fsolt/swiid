...
This measurement error was taken into account by modeling each observation in the source data as normally distributed around the recorded Gini and with variance equal to the squared standard error.
