...
Lastly, where the source data for the country of an observation does not allow the relationship across welfare definitions to be estimated from in-country data as above, the 
for the remaining observations, the estimated relationship $\hat{\rho}_{rwe}$ is used: the estimated ratio of the LIS baseline to Ginis with the same country-year for welfare definition $w$ and equivalence scale $e$ across the same region $r$ as the country of the observation.
