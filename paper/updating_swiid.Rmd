...
This approach has made the SWIID a preferred source of income inequality data for researchers pursuing broadly cross-national work across a wide range of disciplines, including not only economics [e.g., @Berg2018; @Darvas2019], political science [e.g., @Dorsch2019; @Engler2020], and sociology [e.g., @Dawson2018; @JaimeCastillo2019] but also fields with more recent interests in the subject, like public health [e.g., @Ngamaba2016; @Alvarez2017] and psychology [e.g., @Blake2018; @Schmukle2019].
