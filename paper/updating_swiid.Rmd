...
In fact, all twenty combinations of welfare definition and equivalence scale are present in the source data.^[
...
Consumption definitions can vary considerably in whether and how observations treat expenditures of durable goods.
...
<!-- One possible cause of underestimated standard errors are the differences between series of data that remain even after their population coverage, welfare definition, and equivalence scale have been taken into account---that is, the lack of harmonization of the data within any of the categories of the SWIID's multiple-imputation model.   -->
...
<!-- $G_{at} \sim \mathcal{N}(rho_{as} \times G_{st},\,\sigma_s^{2})$ -->
